...
export function ClassCancellationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Class cancelled: {className}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={h1}>Class Cancelled</Heading>
            <Text style={paragraph}>
              We&apos;re sorry to let you know that the following class has been
              cancelled:
            </Text>
            ...
            <Text style={paragraph}>
              We hope to see you at a future class. Check the schedule for upcoming sessions.
            </Text>
